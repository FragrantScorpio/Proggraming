...
Рис.1 Страница настройки навыка<br>
2)Функционал корзины

![](./imag/BinPic.png)
<br>Рис.2 Функционал корзины<br>

3)Функционал помощи

![](./imag/01HelpPic.png)
Рис.3 Функционал помощи<br>

4)Страница управления вебхуками

![](./imag/HookListPic.png)
Рис.4 Страница веюхуков<br>

4)Excel файл

[Ссылка на blob](./Blob.xlsx)
...
<br>Вывод: я научился методу webhook'ов, научился открывать локальный сервер через ngrok а так же благодаря этому создавать навык для алисы, эти навыки в будущем мне могут неплохо пригодиться!

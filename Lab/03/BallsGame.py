...
def load_assets():
    ...
    _assets.update({
        "cell" : Image.open("GameAssets/cell-bgr.png").convert('RGBA'),
        "page" : Image.open("GameAssets/page-bgr.png").convert('RGBA'),
    })
    _assets.update({
    ...
    _assets_balls = {
        "pink"   : Image.open("GameAssets/ball-pink.png").convert('RGBA'),
        "red"    : Image.open("GameAssets/ball-red.png").convert('RGBA'),
        "yellow" : Image.open("GameAssets/ball-yellow.png").convert('RGBA'),  
        "green"  : Image.open("GameAssets/ball-green.png").convert('RGBA'),
        "aqua"   : Image.open("GameAssets/ball-aqua.png").convert('RGBA'),
        "blue"   : Image.open("GameAssets/ball-blue.png").convert('RGBA'),
        "violet" : Image.open("GameAssets/ball-violet.png").convert('RGBA'),
    }
